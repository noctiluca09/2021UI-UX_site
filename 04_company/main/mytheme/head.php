...
<div id="hd">
    ...
    <nav id="gnb">
        ...
        <div class="gnb_wrap">
          ...
          <div id="logo">
              <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/images/top_logo_b.png" alt="<?php echo $config['cf_title']; ?>"></a>
          </div>
            ...
            <ul id="gnb_1dul">
                ...
                <?php } ?>
                <select name="laguage" style="margin-top:17px">
